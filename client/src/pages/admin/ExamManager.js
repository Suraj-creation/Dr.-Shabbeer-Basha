...
const ExamManager = () => {
  ...
  return (
    <div className="manager-page">
      <div className="page-header"><h2>Exam Manager</h2><button className="btn-primary" onClick={() => setShowForm(!showForm)} disabled={!selectedCourse}>{showForm ? 'Cancel' : 'Add New'}</button></div>
